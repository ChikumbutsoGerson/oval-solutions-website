              ...
              <div className="relative mx-auto h-full px-4 pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                  ...
                  <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-2 lg:mt-20 lg:grid-cols-3">
                    {data.map((member) => (
                      <div key={member._id} className="w-full h-1/2 px-10 pt-0">
                        <div className="relative mb-32  max-w-sm mx-auto mt-24 flex-1">
                            ...
                            <div className="px-6 mt-16">
                              <div className="mt-16 flex flex-col items-center">
                                ...
                                <p className="text-base font-normal text-gray-600">
                                  {member.position.length > 22
                                    ? `${member.position.slice(0, 22)}...`
                                    : member.position}
                                </p>
                              </div>
                              <p className="text-start text-gray-600 text-sm font-serif pt-3">
                                {member.brief.length > 256
                                  ? `${member.brief.slice(0, 256)}...`
                                  : member.brief}
                              </p>
