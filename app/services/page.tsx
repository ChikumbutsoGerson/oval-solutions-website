                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                    ...
                    {data.map((service) => (
                        <div  key={service._id} 
                            ...
                            <div
                                className="absolute bg-green-500/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-green-800 group-hover:w-1/2  ">
                            </div>
                        ...
                        />)}
                            <div className="p-5">
                                    ...
                                    <h5 className="mb-2 text-2xl  font-bold tracking-tight text-yellow-600 dark:text-white">
                                      {service.name}</h5>
                                ...
                                <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 absolute bottom-4 mt-12 right-4">
                                    Know More...
