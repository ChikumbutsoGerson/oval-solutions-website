                  ...
                  <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                    <div className="max-w-xl mx-auto text-center">
                      ...
                      <p className="mt-1 text-base leading-relaxed text-gray-600 font-sarif group-hover:text-white">
                        A list of our services for your attention A list of our
                        services for your
                      </p>
                    </div>
                      ...
                      >
                        ...
                        <div className="max-w-sm  dark:bg-gray-800 dark:border-gray-700">
                          ...
                          <div className="p-5">
                            ...
                            <a
                              href="#"
                              className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 absolute bottom-4 mt-12 right-4"
                            >
                              Know More...
                              <svg
