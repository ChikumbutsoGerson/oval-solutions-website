      ...
      <div className="flex flex-wrap -mx-4 lg:justify-between">
         <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
                    <div className="mt-1 text-base leading-relaxed text-gray-600 font-sarif group-hover:text-white">
                       CONTACT US
                        </div>
               ...
               <p
                  className="text-base leading-relaxed ml-6 text-body-color dark:text-dark-6 mb-9"
                  >
                  Below are the details of our contact numbers, email addresses and physical
                    address for you to easily reach us
               </p>
               <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                     ...
                     Royal Hardware Building, Top
                    Floor Next to Cash Build,
                    Opposite Malawi Housing
                    Corporation
                    Area 4
                     </p>
                  </div>
         ...
         <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div
               ...
               >
                     <img className="w-full h-full object-cover" src='https://projects.piglja.com/wp-content/uploads/2022/07/contact.jpeg'/>
