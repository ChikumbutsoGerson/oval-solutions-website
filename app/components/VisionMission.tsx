  ...
  return (
    ...
    <div id="mission-vision" className="mx-auto max-w-6xl">
      ...
      <li  className="w-full lg:w-[50%] px-10 pt-16 pb-8 bg-white rounded-lg self-stretch hover:scale-105 hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)] transition-all duration-150 ease-in relative group">
                <div
                    className="absolute top-0 left-1/2 -translate-x-1/2 rounded-br-xl rounded-bl-xl  group-hover:text-white transition-all duration-150 ease-in group-hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)]">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <h2
                    className="text-center font-semibold text-3xl tracking-wider mb-3">
                    VISION</h2>
            ...
            Endeavor to be the best ICT solutions support firm that
            provides our clients quality and affordable services.
          </p>
                </button>
              
            </li>
            <li
                className="w-full lg:w-[50%] px-10 pt-16 pb-8 bg-white rounded-lg self-stretch hover:scale-105 hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)] transition-all duration-150 ease-in relative group">
                <div
                    className="absolute top-0 left-1/2 -translate-x-1/2 rounded-br-xl rounded-bl-xl  group-hover:text-white transition-all duration-150 ease-in group-hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)]">
                        <div className="flex items-center justify-center h-12 w-12 rounded-md bg-green-900 text-white mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                Technology (ICT) solutions to your organization at affordable prices.
          </p>
                </button>
            </li>
        </ul>
