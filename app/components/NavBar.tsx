...
const NavBar = () => {
  // State for tracking the menu's open/closed status
  ...
  return (
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#16185129]/90 bg-green-600 backdrop-blur-md z-50 px-4 md:px-10 py-4">
      <nav className={`flex flex-col md:flex-row items-center justify-between`}>
        ...
        {/* Navigation Links */}
        <div className={`md:space-y-0 space-y-4 md:space-x-8 md:flex ${isMenuOpen ? 'block justify-between items-stretch' : 'hidden'}`}>
