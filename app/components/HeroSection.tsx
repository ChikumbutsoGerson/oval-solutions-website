        ...
        <div className="absolute flex flex-col justify-center w-full mb-20 mx-auto overflow-x-hidden text-center top-20">
          <div className="max-w-xl mx-auto mt-12 md:max-w-5xl">
            ...
            <h1 className="text-3xl text-gray-900 font-extrabold leading-tight sm:text-5xl sm:leading-tight lg:text-7xl lg:leading-tight">
              OVAL
              <span className="text-yellow-200 pl-4">SOLUTIONS</span>
            </h1>
            <p className="mt-6 text-xl font-medium leading-7 font-sans text-gray-600">
              Professionals with diverse expertise and experience in various ICT
              segments committed and dedicated to serving you, our clients, with
              a great attitude
            </p>
            <button
              type="button"
