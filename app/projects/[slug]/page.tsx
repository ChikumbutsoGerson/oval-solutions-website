  ...
  try {
      ...
      return (
           ...
           <article className="w-full mx-auto p-5">
            ...
            <p className="mb-2">Published On - <span className="font-semibold text-base">{new Date(data._createdAt).toLocaleDateString('en-US', { month: 'long',day: 'numeric',  year: 'numeric', hour: 'numeric', minute: 'numeric', hour12: true })}</span></p>

            <h2 className="text-2xl [18px] mb-2">
              {data.overview}
              </h2>
            <div>
            </div>
